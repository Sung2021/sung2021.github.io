...
<!-- [For AZ position](etc/AZ_Sr.Scientist_Qualification.html)<br> -->
...
#### TCGA DB data analysis workflow 
<a href="https://sung2021.github.io/works.io/samples/RNAseq/TCGA/TCGA_BRCA_RNAseq_index.html" style="font-size: 14px;">TCGA-BRCA Transcriptome Analysis</a><br>
...
* Postdoctoral Fellow at University of Michigan
  * Various NGS platform in-lab setting (DROP-seq, Seq-well, BD-Rapsody, Slide-Seq, and Seq-scope (Contribution to the platform development, Cell, 2021) 
