...
<br>
I am an enthusiastic Senior Bioinformatics Scientist with extensive experience in analyzing next-generation sequencing (NGS) data, particularly in the context of academic research and patient-derived samples. My expertise lies in the seamless integration of multi-omic data sets, including transcriptomics, genomics, epigenomics, and clinical data, to propel forward target discovery research in various biological domains. At the Dana-Farber Cancer Institute, my work primarily involved dissecting complex data from drug combination trials and providing pivotal bioinformatics insights. I am deeply passionate about my research, consistently enthusiastic about adopting innovative methodologies, and I excel in biological research and focus on uncovering new targets for therapeutic intervention.    

<br>

## Resume (pdf) <a id="resume-pdf"></a>   
<a href="info/resume/SungRyePark_resume2405.pdf" style="font-size: 18px;">Sung Rye Park's resume</a><br>
<br>
...
<br>
<a href="https://sung2021.github.io/works.io/samples/RNAseq/TCGA/TCGA_BRCA_application.html" style="font-size: 20px;">TCGA-BRCA Transcriptome Analysis</a><br>
