...
<br>
<img src="png/scRNA_UMAP.png" style="width: 50%; border: 0.5px solid black;"><br><br>

* Initial Processing 
  * CellRanger
  * Doublet Removals
  * Filtering by UMI and other parameters
* UMAP and Clustering
* Cluster-markers enrichment analysis
* Cell type annotation 
* Population shift analysis
* Integration (Harmony, CCA)
* AUC 
* Imputation
...
#### [Example: RNA-seq Analysis using TCGA DB data](https://sung2021.github.io/works.io/samples/RNAseq/TCGA/TCGA_BRCA_RNAseq_index.html) 
