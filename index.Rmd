...
* I am an enthusiastic Senior Bioinformatics Scientist with extensive experience in analyzing various NGS data, in the academic research setting and patient-derived samples.  
* My expertise lies in the seamless integration of multi-omic data sets, including transcriptomics, genomics, epigenomics, and clinical data, to propel forward target discovery research in various biological domains. 
* My work primarily involves dissecting complex data from drug combination trials and providing pivotal bioinformatics insights. I am deeply passionate about my research, consistently enthusiastic about adopting innovative methodologies, and I excel in biological research and focus on uncovering new targets for therapeutic intervention.    

<br>
 
<a href="info/resume/SungRyePark_resume2405.pdf" style="font-size: 18px;">Sung Rye Park's resume (pdf)</a><br>
<br>
